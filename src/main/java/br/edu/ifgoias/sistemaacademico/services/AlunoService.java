...
public class AlunoService {
	...
	public void update(Integer id, Aluno object) {
		repository.findById(id).map(
				aluno->{	aluno.setNome(object.getNome());
							aluno.setSexo(object.getSexo());
							aluno.setDt_nasc(object.getDt_nasc());
							aluno.setNota(object.getNota());
